...
std::shared_ptr<sf::SoundBuffer> ic::getBufferFromName(const std::string& buffername) {
...
std::shared_ptr<sf::Music> ic::getMusicFromName(const std::string& musicname) {
