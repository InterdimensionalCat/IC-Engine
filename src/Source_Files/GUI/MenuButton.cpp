...
MenuButton::MenuButton(const s2d::ScreenUnits::Point& center, const string& text, const string& font, const size_t& fontSize, MenuState* parent) : Button(s2d::ScreenUnits::Rectangle(0,0,1,1), 0.0f, Color(0,0,0,0), Color(0,0,0,0)), parent(parent) {
	...
	cent += s2d::ScreenUnits::Vec(0.0f, option.getGlobalBounds().height / 2);
